...
public class LifeExpectancy extends PApplet {
	...
	private Map<String, Float> loadLifeExpectancyFromCSV(String fileName) {
		...
		for (String row : rows) {
			...
			// NOTE: Splitting on just a comma is not a great idea here, because the csv file might have commas in their entries, as this one does.  
			// We do a smarter thing in ParseFeed, but for simplicity, we just use a comma here, and ignore the fact that the first field is split.
