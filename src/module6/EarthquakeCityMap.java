...
public class EarthquakeCityMap extends PApplet{
	...
	public void setup() {		
	    ...
	    title.setTitle("Earthquake City Map");
	    ...
	    for(PointFeature feature : earthquakes) {
		  //check if LandQuake
		  if(isLand(feature)) {
			  LandQuakeMarker lq = new LandQuakeMarker(feature);
			  quakeMarkers.add(lq);
		  }
		  // OceanQuakes
		  else {
			  OceanQuakeMarker oq = new OceanQuakeMarker(feature);
			  quakeMarkers.add(oq);
		  }
	    }
	...
	// TODO: Add the method:
	// private void sortAndPrint(int numToPrint) and then call that method from setUp
	private void sortAndPrint(int numToPrint) {
		...
		for (Object m : markers)
			if (count < numToPrint) {
				System.out.println(((EarthquakeMarker)m).toString());
				count++;
			}
			else {
				break;
