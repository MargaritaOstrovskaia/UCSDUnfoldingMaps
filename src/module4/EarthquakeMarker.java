...
public abstract class EarthquakeMarker extends SimplePointMarker
{
	...
	// by Earthquake marker: protected float radius;
	//
	...
	public void draw(PGraphics pg, float x, float y) {
		...
		if (age.equals("Past Hour")) {
			...
			pg.fill(0,0,0);
			pg.line(x-(sizeLine/2), y-(sizeLine/2), x+(sizeLine/2), y+(sizeLine/2));
			pg.line(x-(sizeLine/2), y+(sizeLine/2), x+(sizeLine/2), y-(sizeLine/2));
		}
	...
	// determine color of marker from depth, and set pg's fill color using the pg.fill method.
